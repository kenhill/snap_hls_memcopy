...
# Add FPGA binaries
COPY JARVICENAE-0A0A184E_SDRAM_ADKU3_13.tar.gz /etc/NAE/CAPI.tar.gz
COPY JARVICENAE-0A0A184E_SDRAM_ADKU3_13.signature.sha256 /etc/NAE/CAPI.signature.sha256
